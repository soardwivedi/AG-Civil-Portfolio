      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-lg mt-4 max-w-2xl mx-auto font-sans">
            Ready to start your project? Get in touch for expert civil
          ...
          >
            <div className="bg-[#13131f] border border-white/10 p-6 md:p-8 flex-1">
              ...
              <p className="text-gray-400 text-sm mb-8 font-sans">
                Available for consultancy projects across India. Reach out to
              ...
              <div className="flex flex-col gap-5">
                {contactInfo.map((item) => (
                  ...
                  >
                    <div
                      className="w-12 h-12 bg-[#ff6a00]/10 border border-[#ff6a00]/20 flex items-center 
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        {projectTypes.map((t) => (
                          <option key={t} value={t} className="bg-[#13131f]">
                            {t}
                          </option>
                        ))}
                      </select>
