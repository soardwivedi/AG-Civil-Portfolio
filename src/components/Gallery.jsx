      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-lg mt-4 max-w-2xl mx-auto font-sans">
            Visual showcase of infrastructure projects — WTP, STP, pumping
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {galleryItems.map((item, index) => (
            ...
            >
              ...
              {/* Overlay on hover */}
              <div
                className="absolute inset-0 bg-[#ff6a00]/0 group-hover:bg-[#ff6a00]/20 
      ...
      {selected && (
        ...
        >
          ...
          >
            ...
            <div
              className={`w-full aspect-video bg-gradient-to-br ${selected.bg} flex items-center justify-center mb-6`}
            >
              <selected.icon
