  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
        <span
          className="font-heading font-black text-[12vw] uppercase text-white/[0.02] select-none whitespace-nowrap"
        >
          CIVIL ENGINEERING
        </span>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 w-full pt-24 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Providing expert services in estimation, project execution,
              tender documentation, and infrastructure consultancy.
            </motion.p>
            ...
            >
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: '0 0 30px rgba(255,106,0,0.5)' }}
                whileTap={{ scale: 0.95 }}
            ...
            >
              {[
                ...
                <div key={stat.label} className="flex flex-col">
                  <span className="font-heading font-black text-3xl text-[#ff6a00]">{stat.value}</span>
          ...
          >
            ...
            <div className="relative bg-[#13131f] border border-[#ff6a00]/20 p-8 overflow-hidden">
              ...
              <div className="absolute top-0 right-0 w-24 h-24 bg-[#ff6a00] opacity-80"
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-center gap-4 p-4 bg-[#1a1a2e] border-l-4 border-[#ff6a00]">
                  ...
                  <div>
                    <div className="font-heading font-bold text-white text-lg">300 MLD Water Treatment Plant</div>
                    <div className="text-gray-400 text-sm">Ahmedabad, Gujarat</div>
                    <div className="text-[#ff6a00] text-sm font-bold mt-1">₹ 206 Crore</div>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-4 bg-[#1a1a2e] border-l-4 border-[#ff6a00]/60">
                  ...
                  <div>
                    <div className="font-heading font-bold text-white text-lg">65 MLD Sewage Treatment Plant</div>
                    <div className="text-gray-400 text-sm">Gandhinagar, Gujarat</div>
                    <div className="text-[#ff6a00] text-sm font-bold mt-1">₹ 95 Crore</div>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-4 bg-[#1a1a2e] border-l-4 border-[#ff6a00]/40">
                  ...
                  <div>
                    <div className="font-heading font-bold text-white text-lg">3500 TCD Sugar Plant</div>
                    <div className="text-gray-400 text-sm">Karnal, Haryana</div>
                    <div className="text-[#ff6a00] text-sm font-bold mt-1">₹ 80 Crore</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
                <span className="text-gray-400 text-sm">Infrastructure Projects</span>
                <span className="text-[#ff6a00] font-bold text-sm uppercase tracking-wider">View All →</span>
              </div>
            </div>
            ...
            >
              ...
              <div className="text-xs uppercase tracking-wider font-bold">Years Exp.</div>
            </motion.div>
