...
import { FiMail, FiPhone, FiMapPin, FiLinkedin, FiArrowUp } from 'react-icons/fi'
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 relative z-10">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <button onClick={scrollToTop} className="flex items-center gap-3 mb-4 group">
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="font-heading text-xs tracking-[0.3em] text-gray-400 uppercase">Consultancy</span>
              </div>
            </button>
            <p className="text-gray-500 text-sm leading-relaxed font-sans mb-6">
              Professional Civil Engineering Consultancy specializing in infrastructure projects, STP/WTP, and EPC project execution across India.
            </p>
            {/* Social */}
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <a href="mailto:abhigarg15071999@gmail.com"
                ...
                <span className="text-sm font-sans break-all">abhigarg15071999@gmail.com</span>
              </a>
              <a href="tel:+919813584799"
        ...
        <div className="py-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-sm font-sans text-center sm:text-left">
            © 2026 <span className="text-[#ff6a00] font-bold">AG Civil Consultancy</span>. All Rights Reserved.
          </p>
          <p className="text-gray-700 text-xs font-sans">
            Designed by <span className="text-gray-600">AG Civil Consultancy</span>
          </p>
        </div>
      </div>
