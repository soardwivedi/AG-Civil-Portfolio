...
function AnimatedCounter({ value, suffix }) {
  ...
  return (
    <span ref={ref} className="font-heading font-black text-5xl md:text-6xl text-white leading-none">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {counters.map((counter, index) => (
            ...
            >
              ...
              <div className="text-white/60 text-xs mt-1 font-sans">{counter.sublabel}</div>
            </motion.div>
          ))}
        </div>
      </div>
