...
import { useScrollAnimation, staggerContainer, scaleIn } from '../hooks/useScrollAnimation'
import {
  MdCalculate, MdListAlt, MdReceiptLong, MdDescription,
  MdDraw, MdSchedule, MdWater, MdSearch, MdBarChart, MdEngineering
} from 'react-icons/md'
...
export default function Services() {
  ...
  return (
    <section id="services" className="relative py-24 bg-[#0d0d14] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
        ...
        >
          ...
          <div className="text-[#ff6a00] font-bold text-sm uppercase tracking-widest mb-3">What I Offer</div>
          ...
          <p className="text-gray-400 text-lg mt-4 max-w-2xl mx-auto font-sans">
            Comprehensive civil engineering consultancy services tailored for infrastructure,
            government, and EPC projects.
          </p>
        </motion.div>
        ...
        >
          {services.map((service, index) => (
            ...
            >
              {/* Number */}
              <div className="absolute top-3 right-4 font-heading font-black text-5xl text-white/[0.04] 
              ...
              {/* Icon */}
              <div className="w-12 h-12 bg-[#ff6a00]/10 flex items-center justify-center mb-4
              ...
              {/* Arrow */}
              <div className="mt-4 text-[#ff6a00] font-bold text-sm opacity-0 group-hover:opacity-100 
