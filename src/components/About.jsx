...
const expertiseItems = [
  {
    icon: GiWaterTower,
    label: "Water & Sewage Treatment Plants",
    color: "#ff6a00",
  },
  ...
  return (
    <section id="about" className="relative py-24 bg-[#13131f] overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(45deg, #ff6a00 0, #ff6a00 1px, transparent 0, transparent 50%)",
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative bg-[#0d0d14] border border-[#ff6a00]/20 p-8 overflow-hidden">
              ...
              <div className="flex flex-col items-center text-center mb-8">
                ...
                <p className="text-[#ff6a00] font-bold text-sm uppercase tracking-widest mt-1">
                  Civil Engineer
                </p>
              ...
              <div className="grid grid-cols-3 gap-4">
                {highlights.map((item) => (
                  <div
                    key={item.label}
                    className="bg-[#1a1a2e] p-3 text-center border border-white/5 hover:border-[#ff6a00]/30 transition-colors"
                  >
                    <item.icon className="text-[#ff6a00] text-2xl mx-auto mb-2" />
                    <div className="font-heading font-black text-xl text-white">
                      {item.value}
                    </div>
                    <div className="text-gray-500 text-xs uppercase tracking-wider leading-tight mt-1">
                      {item.label}
                    </div>
                  </div>
                ))}
          ...
          >
            ...
            <div className="text-[#ff6a00] font-bold text-sm uppercase tracking-widest mb-2">
              About
            </div>
            <h2 className="font-heading font-black text-4xl md:text-5xl lg:text-6xl uppercase leading-none text-white mb-6">
              Abhimanyu <br />
              <span className="text-[#ff6a00]">Garg</span>
            </h2>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-4 font-sans">
              ...
              in large-scale infrastructure and EPC projects including{" "}
            ...
            <p className="text-gray-400 text-base leading-relaxed mb-6 font-sans">
              ...
              <span className="text-[#ff6a00] font-bold">200+ Crores</span>,
              Abhimanyu specializes in project execution, estimation, billing,
              tender documentation, and site inspection. His experience spans
              government departments and leading engineering companies across
              India.
            </p>
